const TextalignJustifycenter = ({
  ...
  if (type === "broken") {
    return (
      ...
      >
        <path
          d="M3 4.5h18M3 14.5h18M3 19.5h18M13.95 9.5H3M21 9.5h-2.98"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
  ...
  if (type === "bulk") {
    return (
      ...
      >
        ...
        <path
          opacity=".4"
          d="M21 10.25H3c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h18c.41 0 .75.34.75.75s-.34.75-.75.75Z"
          fill={color}
        ></path>
        <path
