const Driver2 = ({ type = "linear", size = 24, color = "currentColor", className="" }) => {
  if (type === "bold") {
    return (
  ...
  if (type === "broken") {
    return (
      ...
      >
        <path
          d="M6 6.25v2M10 6.25v2M2 9c0-5 2-7 7-7h6c5 0 7 2 7 7v6c0 5-2 7-7 7H9c-5 0-7-2-7-7v-3h16M6 16v2M10 16v2M14 7.25h4M14 17h4"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
  ...
  if (type === "twotone") {
    return (
      ...
      >
        ...
        <path
          opacity=".4"
          d="M6 16v2M10 16v2M14 7.25h4M14 17h4"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
