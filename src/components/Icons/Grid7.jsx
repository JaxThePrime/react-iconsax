const Grid7 = ({ type = "linear", size = 24, color = "currentColor", className="" }) => {
  if (type === "bold") {
    return (
  ...
  if (type === "bulk") {
    return (
      ...
      >
        <path
          opacity=".4"
          d="M12 10v12H7.81C4.17 22 2 19.83 2 16.19V10h10Z"
          fill={color}
        ></path>
        <path
        ...
        <path
          opacity=".6"
          d="M22 10v6.19c0 3.64-2.17 5.81-5.81 5.81H12V10h10Z"
          fill={color}
        ></path>
      </svg>
    );
