const Mouse = ({ type = "linear", size = 24, color = "currentColor", className="" }) => {
  if (type === "bold") {
    return (
    ...
    return (
      ...
      >
        ...
        <g
          ...
          strokeLinejoin="round"
        >
          <path d="M12 11c-.83 0-1.5-.67-1.5-1.5v-2c0-.83.67-1.5 1.5-1.5.82 0 1.5.67 1.5 1.5v2c0 .83-.68 1.5-1.5 1.5ZM12 6V2"></path>
        </g>
      </svg>
    );
  }
